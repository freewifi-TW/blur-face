...
| `--smooth` | `6` | 追蹤框尺寸平滑：寬高取前後 N 幀偵測框的最大值，消除臉框／頭框交替造成的忽大忽小；0 停用 |
